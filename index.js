...
const uri = `mongodb+srv://${process.env.DB_PASS}:${process.env.DB_USER}@cluster0.rrq7z.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
client.connect(err => {
  ...
  const volunteersCollection = client.db(`${process.env.DB_NAME}`).collection("volunteers");
    ...
    app.get('/volunteers', (req,res) => {
        if(req.query.email === "masud309060@gmail.com"){
